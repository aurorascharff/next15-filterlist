  ...
  return (
    <Link
      ...
      className={cn(
        ...
        'flex w-full min-w-fit flex-col gap-3 border-b-4 p-3 outline-none outline-1 -outline-offset-2 hover:bg-primary-light sm:gap-6 sm:p-6 dark:hover:bg-neutral-800',
      )}
      href={href}
    >
